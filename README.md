...
![Backend](https://skillicons.dev/icons?i=python,golang,nodejs,lua,java,cpp&titles=true)

![Package Manager](https://skillicons.dev/icons?i=npm,pnpm,yarn&titles=true)

![Frontend](https://skillicons.dev/icons?i=html,javascript,css,tailwindcss,react,nextjs,typescript,vite,electron&titles=true)

![Databases](https://skillicons.dev/icons?i=mysql,mongodb,redis&titles=true)

![Social](https://skillicons.dev/icons?i=git,github,gitlab,discord&titles=true)

![Others](https://go-skill-icons.vercel.app/api/icons?i=wsl,vmwareworkstation,kali,sqlite,&titles=true)
